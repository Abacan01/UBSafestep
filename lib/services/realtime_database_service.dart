...
class RealtimeDatabaseService {
  ...
  // Listen specifically for SOS status changes
  Stream<bool> getSOSStatus(String deviceId) {
    final ref = _database.child('devices/$deviceId/sos_active');
    
    return ref.onValue.map((event) {
      final value = event.snapshot.value;
      final isActive = value == true || value == 'true';
      print('🚨 [RTDB] SOS status: $isActive');
      return isActive;
    });
  }
